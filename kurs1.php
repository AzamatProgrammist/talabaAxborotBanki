...
<body>
	...
	<div id="kurs1">
		<div class="container">
			<h1>Informatika 1-kurs talabalarining axborot banki</h1>	
			<div class="box1">
				<img alt="8-17" src="img/2.jpg">
				<p><strong>7-17 Guruh</strong></p>
				<button class="batafsil"><a class="btns" href="kurs1_1.php">Batafsil</a></button>
			</div>
			<div class="box1">
				<img alt="8-17" src="img/1.png">
				<p><strong>8-17 Guruh</strong></p>
