 ...
 <table border="1">
 	...
 	<tbody>
 		...
 		<?php
 			...
 			$sn = 1;
 			$sql = "SELECT * FROM kurs1_1 WHERE viloyati LIKE '%$q%' OR tumani LIKE '%$q%' OR OTga_kirgan_yil LIKE '%$q%' OR fio LIKE '$q' UNION SELECT *  FROM kurs1_2 WHERE viloyati LIKE '%$q%' OR tumani LIKE '%$q%' OR OTga_kirgan_yil LIKE '%$q%' OR fio LIKE '$q'";
