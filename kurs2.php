...
<body>
	...
	<div class="boy">
		<div id="header">
			...
			<ul class="menu">
				...
				<li class="belgi"><a class="belgi" href="kurs2.php">2-kurs</a></li>
	...
	<div id="kurs1">
		<div class="container">
			<h1>Informatika 2-kurs talabalarining axborot banki</h1>	
			<div class="box1">
				<img alt="8-17" src="img/3.jpg">
				<p><strong>7-16 Guruh</strong></p>
				<button class="batafsil"><a class="btns" href="kurs1_2.php">Batafsil</a></button>
			</div>
			<div class="box1">
				<img alt="8-17" src="img/4.jpg">
				<p><strong>8-16 Guruh</strong></p>
				<button class="batafsil"><a class="btns" href="kurs1_2.php">Batafsil</a></button>
			</div>
		</div>
	</div>
