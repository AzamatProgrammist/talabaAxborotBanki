...
<body>
	...
	<div class="boy">
		<div id="header">
			...
			<ul class="menu">
				...
				<li class="belgi"><a class="belgi" href="kurs4.php">4-kurs</a></li>
			</ul>
	...
	<div id="kurs1">
		<div class="container">
			<h1>Informatika 4-kurs talabalarining axborot banki</h1>	
			<div class="box1">
				<img alt="8-17" src="img/7.jpg">
				<p><strong>7-14 Guruh</strong></p>
				<button class="batafsil"><a class="btns" href="kurs1_2.php">Batafsil</a></button>
			</div>
			<div class="box1">
				<img alt="8-17" src="img/9.jpg">
				<p><strong>8-14 Guruh</strong></p>
				<button class="batafsil"><a class="btns" href="kurs1_2.php">Batafsil</a></button>
			</div>
		</div>
	</div>
