...
<body>
	...
	<div id="kurs1_11">
		<div class="container">
			...
			<form class="kurs1_11Forma" action="" method="POST" enctype="multipart/form-data" id="frmName">
				<br>
			<div class="forma">
			...
			<div class="forma">
				<label>fio:</label>
				<input type="text" name="fio" id="myname">
			</div>
			<div class="forma">	
			...
			<div class="forma">	
				<label>kurator:</label>
				<input type="text" name="kurator" value="<?php echo $result['kurator'] ?>" required>
			</div>
			<div class="forma">
				<label>Tug_yil_oy_kun:</label>
				<input type="date" name="Tug_yil_oy_kun" required>
			</div>
				<button class="btn" type="submit" name="submit">Qo'shish</button>
			</form>
		</div>
	</div>
		<?php 
			...
			if (isset($_POST['submit'])) {
				...
				$results = $crud->getInsertDetails($images, $guruh, $fio, $fakultet, $yonalishi, $talim_turi, $kursi, $viloyati, $tumani, $D_Y_J, $Tel_raqami, $PasSerRaq, $OTga_kirgan_yil, $kurator, $Tug_yil_oy_kun);
				if ($results) {
