...
<body>
	...
	<div id="kurs1_11">
		<div class="container">
			...
			<form class="kurs1_11Forma" action="" method="POST" enctype="multipart/form-data">
				<br>
				<input type="hidden" name="imagess" value="<?php echo $result['img']; ?>">
	...
	if (isset($_FILES['image']['name']) && ($_FILES['image']['name'] !="")) {
 	...
 	$result = $crud->getUpdateKurs($id, $picProfile, $guruh, $fio, $fakultet, $yonalishi, $talim_turi, $kursi, $viloyati, $tumani, $D_Y_J, $Tel_raqami, $PasSerRaq, $OTga_kirgan_yil, $kurator, $Tug_yil_oy_kun);
